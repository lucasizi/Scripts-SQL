...
/*
    'LANGUAGE' - lingua;
    'LANG' - pa?s;
    'INSTANCE' - inst?ncia (importante no ambiente RAC - Real Application Cluster);
    'TERMINAL' - nome do computador onde est? a correr o cliente Oracle - quando o cliente ? Java (JDBC) aparece em branco;
    'SESSIONID'- n?mero da sess?o Oracle que est? em execu??o;
*/
...
-- Par?metros de Linguagem da Sess?o do Oracle no Padr?o brasileiro:
--facilita a compatibilidade de caracteres, num?ricos e datas no padr?o brasileiro.
